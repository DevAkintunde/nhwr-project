// basic TSX containers to be custimised for app needs
...
export function Spinner() {
	return (
		<div className={`${shimmer} text-center my-4 mx-auto w-full flex place-content-center`}>
			<Icons.Spinner className="text-7xl p-3 spinner" />
		</div>
	);
}
